      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex-1">
              ...
              <div className="h-4 bg-green-100 rounded animate-pulse mb-1 w-32"></div>
              <div className="h-3 bg-green-100 rounded animate-pulse w-64 sm:w-96"></div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-white border border-green-200 rounded-lg p-4 sm:p-6">
              <div className="h-5 sm:h-6 bg-green-200 rounded animate-pulse mb-4 w-24 sm:w-32"></div>
              <div className="space-y-3">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="h-10 bg-green-50 rounded animate-pulse"></div>
                ))}
              </div>
            </div>
          </div>
