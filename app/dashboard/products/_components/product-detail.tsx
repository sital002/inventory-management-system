            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  <span>ID: {product._id.toString()}</span>
                  <Separator orientation="vertical" className="h-4" />
                  <Badge
                    variant={
                      stockStatus === "In Stock" ? "default" : "secondary"
                    }
                    className={`${getStatusColor(stockStatus)}`}
                  >
                    {stockStatus}
                  </Badge>
                </div>
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            <label className="text-sm font-medium text-gray-500 mr-3">
                              Stock Status
                            </label>
                            <Badge
                              variant={
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        <div>
                          ...
                          <p className="mt-1 text-2xl font-bold text-green-600">
                            ${(product.stockLevel * product.price).toFixed(2)}
                          </p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">
                          ...
                          <p className="mt-1 text-lg font-medium">
                            $
                            {(product.stockLevel * product.costPrice).toFixed(
                              2
                            )}
                          </p>
                        </div>
